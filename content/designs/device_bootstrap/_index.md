...
#### Associating customers to their devices
...
* Devices are provisoned during manufacturing process with **certificates** and those can be pre-mapped to a device profile. This is common with customers who have known large fleets of devices.
* Devices report their model and serial numbers during the communication with the Registration Authority, that information can be pre-mapped to a device prfile.
