...
{{< code-include file="implementations/aws/device_bootstrap/aws-iot-certificate-vending-machine/iot-policy.json" language="json" title="Política IoT" >}}
```
...
{{< code-include file="implementations/aws/device_bootstrap/aws-iot-certificate-vending-machine/lambda_function.py" title="Función Lambda - Máquina Expendedora de Certificados" >}}
```
...
{{< code-include file="implementations/aws/device_bootstrap/aws-iot-certificate-vending-machine/device-request.json" language="json" title="Solicitud de Registro del Dispositivo" >}}
```
