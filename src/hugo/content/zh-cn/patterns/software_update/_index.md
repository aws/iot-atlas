...
利用["命令"]({{<ref "/patterns/command">}})和["设备状态副本"]({{<ref "/patterns/device_state_replica">}})设计的 IoT 解决方案，加上一个全球可用且可扩展的存储解决方案，足以应对大量设备进行软件更新时所带来的所有挑战。
...
设备在 IoT 解决方案中通过[设备状态副本]({{<ref "/patterns/device_state_replica">}})获取并执行“更新”命令的逻辑示例如下。具体而言，设备将获得新软件，使用该软件执行更新，并确认完成。
