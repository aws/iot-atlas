...
weight: 50
draft: true
summary: "A device acts as an intermediary between local devices as well as devices and the cloud."
---
...
The local network on the left-hand of the following diagram is commonly called the _shop floor_ in the manufacturing, or _operational technology (OT)_ domains.
