...
{{< code-include file="implementations/aws/command/command1/client.py" language="python" title="client.py - Device Code" >}}
...
{{< code-include file="implementations/aws/command/command1/application.py" language="python" title="application.py - Application Code" >}}
