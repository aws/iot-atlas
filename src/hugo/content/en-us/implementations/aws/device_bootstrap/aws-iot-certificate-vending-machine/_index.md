...
{{< code-include file="implementations/aws/device_bootstrap/aws-iot-certificate-vending-machine/iot-policy.json" language="json" title="IoT Policy" >}}
```
...
{{< code-include file="implementations/aws/device_bootstrap/aws-iot-certificate-vending-machine/lambda_function.py" title="Lambda Function - Certificate Vending Machine" >}}
```
...
{{< code-include file="implementations/aws/device_bootstrap/aws-iot-certificate-vending-machine/device-request.json" language="json" title="Device Registration Request" >}}
```
